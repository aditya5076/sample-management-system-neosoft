            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet__body">
                    ...
                    <div class="report-datatable">
                        <!--begin: Search Form -->
                            <form action="{{ route('updateExistingUser',$userData->id) }}" method="POST">
                            @csrf
                            <div class="container">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Name:</strong>
                                                <input type="text" autocomplete="off" value="{{ $userData->name }}" name="name" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                @isset($role_master)
                                                    ...
                                                    @endif
                                                        <option value="{{ $role['id'] }}" {{ ($role['id'] == $userData->role_id ) ? 'selected' : ''  }}>{{$role['role_name']}}</option>
                                                    @endforeach
                                                @endisset     
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Email:</strong>
                                                <input type="text" autocomplete="off" value="{{ $userData->email }}" name="email" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Company:</strong>
                                                <input type="text" autocomplete="off" value="{{ $userData->company }}" name="company" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <strong>Designation:</strong>
                                                <input type="text" autocomplete="off" value="{{ $userData->designation }}" name="designation" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
