...
class MSSQLDumps implements FromCollection, WithHeadings
{
    ...
    */
    ...
    public function collection()
    {
        ...
        ->select('requests.request_no','products_master.unique_sku_id','products_master.quality','products_master.design_name','products_master.shade','products_master.epi_on_loom','products_master.ppi_on_loom','products_master.epi_finish','products_master.ppi_finish','products_master.gsm','products_master.glm','products_pricing.P3','products_master.designer','products_master.end_use','products_master.product_type','products_master.category','products_master.repeat_inch','products_master.repeat_cm','products_master.finish_width','products_master.repeats_horizontal','products_master.repeats_vertical','products_master.color','products_master.design','products_master.created_at as product_create_date','requests.requirement','requests.barcode','requests.delivery_date','requests.designer_name','requests.sample_length','requests.created_at as request_create_date','products_master.print_design','products_master.print_colorway','products_master.print_repeat_inch','products_master.print_repeat_cm','products_master.print_category','products_master.print_type','products_master.print_cost','products_master.emb_design','products_master.emb_colorway','products_master.emb_repeat_inch','products_master.emb_repeat_cm','products_master.emb_stitch_type','products_master.emb_vendor','products_master.emb_stitches','products_master.emb_applique_work','products_master.emb_cost','products_master.emb_gsm','products_master.emb_category');
        if(!empty($this->from_date) && !empty($this->to_date)){
            $this->query_array = $this->query_array->whereBetween('requests.request_date', [$this->from_date. " 00:00:00", $this->to_date. " 23:59:59"]);
        }
