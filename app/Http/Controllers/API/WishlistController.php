...
{
    /**
     * This controller is used for maintaining functions related to wishlist.
    ...
    */
    ...
    protected $wishlist_storing_rules = [
    ...
    */
    private function process_validator($request)
    {
        ...
        $validator = Validator::make($check_data, $this->wishlist_storing_rules);
        if ($validator->fails()) {
    ...
    /**
    * This function is used for storing wishlist in mysql from IPAD as a process of syncronization.
    * @param Request : $request object
    ...
    */
    public function sync_wishlist(Request $request)
    {
        try {
            ...
            return $this->response_format(true,$this->static_restful_data['success_code'],$this->static_restful_data['success_store_message'],Wishlist::get());
        } catch (\Exception $e) {
    ...
    /**
    * This function is used for common insertion of wishlist records.
    * @param Request : $request object
    * @author Akash Puthanekar <akash.puthanekar@neosofttech.com>
    */
